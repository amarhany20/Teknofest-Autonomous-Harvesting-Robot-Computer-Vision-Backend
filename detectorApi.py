...
result_Item = "Don't press start too much please!"
def detector():
    ...
    while True:
        ...
        if not ret_val:
            ...
            if error_counter > 10:
                ...
                return "please only click on submit one time"
            continue
        ...
        if 47 in classes:
            ...
            if (apple_counter == 5):
                ...
                if (centers[0, 2] > 200 and centers[0, 1] < 150):
                    print("RED APPLE!!!!!!!")
                    result_Item = "Red Apple Found"
                else:
                    result_Item = "Yellow Apple Found"
                    print("Yellow Apple!!!!!!")
